...
{
    public partial class DnD_Start : Form
    {
        public Form1 ParentForm;
        private Boolean OpenMainMenu = true;
        private String Naam;
        public DnD_Start(Form1 ParentForm)
        {
            InitializeComponent();
        ...
        private void DnD_Start_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (OpenMainMenu)
            {
        ...
        {
            OpenMainMenu = false;
            ParentForm.DragnDrop = new DnD_Form(ParentForm, Naam);
            ParentForm.DragnDrop.Show();
            ParentForm.DragnDrop.Location = this.Location;
            this.Close();
        }
